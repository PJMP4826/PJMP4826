...
### [BillsScan](https://github.com/PJMP4826/BillsScanMovil)
Receipt management system with OCR technology for automatic data extraction and organization

### [Agent SQL](https://github.com/PJMP4826/sql-agent-desktop)
Autonomous agent powered by Gemini LLM capable of translating natural language to SQL and querying SQL Server databases

### [Loan Manager](https://github.com/PJMP4826/sistema-prestamos-creditos)
Comprehensive loan and client management system developed in Java with Swing GUI

### [Construction Building Materials Management](https://github.com/PJMP4826/construction-building-materials-management)
RESTful API for construction materials management, developed in pure PHP applying CQRS pattern
